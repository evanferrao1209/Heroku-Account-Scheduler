...
- To Do This, Visit The "Actions" Tab Of Your Fork. A Prompt Telling You That Workflows Are Disabled For Forks Will Come Up. Click Enable Workflow.
- In The Workflows Section Click on "Heroku-Account-Scheduler.yml" Button
- A Prompt Telling You That Scheduled Workflows Are Disabled For Forks Will Come Up. Click Enable Workflow. Now Click On Run Workflow.
